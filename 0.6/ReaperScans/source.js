  ...
  return (function () {
  ...
  })()(
    {
      ...
      13: [
        ...
        { "./APIWrapper": 1, "./base": 12, "./models": 55 },
      ],
      14: [
        function (require, module, exports) {
          "use strict";
      ...
      55: [
        ...
        },
        {
          ...
          "./SourceInfo": 47,
          "./SourceManga": 48,
          "./SourceStateManager": 49,
          "./SourceTag": 50,
          "./TagSection": 51,
          "./TrackedManga": 52,
          "./TrackedMangaChapterReadAction": 53,
          "./TrackerActionQueue": 54,
        },
      ],
      56: [
        function (require, module, exports) {
          ...
          class Readm extends paperback_extensions_common_1.Source {
            ...
            getMangaShareUrl(mangaId) {
              return `${RM_DOMAIN}/manga/${mangaId}`;
            }
            ...
            getViewMoreItems(homepageSectionId, metadata) {
              ...
              return __awaiter(this, void 0, void 0, function* () {
                ...
                metadata = !ReadmParser_1.isLastPage($)
                  ? { page: page + 1 }
                  : undefined;
            ...
            getSearchResults(query, metadata) {
              ...
              return __awaiter(this, void 0, void 0, function* () {
                ...
                if (query.title) {
                  ...
                  if (!data.manga) {
                    console.log(
                      "API Error: Failed to create proper response object, missing manga property!"
                    );
                    return createPagedResults({
                      results: [],
                    });
                  ...
                  for (const m of data.manga) {
                    if (!m.url || !m.title) {
                      console.log(
                        "Missing URL or Title property in manga object!"
                      );
                      continue;
                    }
        ...
        { "./ReadmParser": 57, "paperback-extensions-common": 13 },
      ],
      57: [
        function (require, module, exports) {
          "use strict";
          ...
          exports.isLastPage =
            ...
            exports.parseHomeSections =
            exports.parseUpdatedManga =
            exports.parseTags =
            exports.parseChapterDetails =
            exports.parseChapters =
            exports.parseMangaDetails =
              void 0;
          const paperback_extensions_common_1 = require("paperback-extensions-common");
          ...
          const parseMangaDetails = ($, mangaId) => {
            ...
            const altTitles = $("div.sub-title.pt-sm")
              .text()
              .split(/, |; |\| /);
            ...
            const image = parseImage
              ? RM_DOMAIN + parseImage
              : "https://i.imgur.com/GYUxEX8.png";
            const author =
              (_a = $("small", "span#first_episode").text().trim()) !== null &&
              _a !== void 0
                ? _a
                : "";
            const artist =
              (_b = $("small", "span#last_episode").text().trim()) !== null &&
              _b !== void 0
                ? _b
                : "";
            const description = decodeHTMLEntity(
              (_c = $("p", "div.series-summary-wrapper").text().trim()) !==
                null && _c !== void 0
                ? _c
            ...
            for (const tag of $("a", $("div.ui.list", "div.item")).toArray()) {
              ...
              const id =
                (_e =
                  (_d = $(tag).attr("href")) === null || _d === void 0
                    ? void 0
                    : _d.replace("/category/", "")) !== null && _e !== void 0
                  ? _e
                  : "";
          ...
          const parseChapters = ($, mangaId) => {
            ...
            for (const chapter of $("div.season_start").toArray()) {
              const title =
                (_a = $("h6.truncate", chapter).first().text().trim()) !==
                  null && _a !== void 0
                  ? _a
                  : "";
              const rawChapterId =
                (_b = $("a", chapter).attr("href")) !== null && _b !== void 0
                  ? _b
                  : "";
              ...
              const date = parseDate(
                (_d =
                  (_c = $("td.episode-date", chapter)) === null || _c === void 0
                    ? void 0
          ...
          const parseTags = ($) => {
            ...
            for (const tag of $(
              "li",
              "ul.trending-thisweek.categories"
            ).toArray()) {
              const label = $("a", tag).text().trim();
              const id =
                (_b =
                  (_a = $("a", tag).attr("href")) === null || _a === void 0
                    ? void 0
                    : _a.replace("/category/", "")) !== null && _b !== void 0
                  ? _b
                  : "";
              if (!id || !label) continue;
              arrayTags.push({ id: id, label: label });
          ...
          const parseUpdatedManga = ($, time, ids) => {
            ...
            let loadMore = true;
            for (const manga of $(
              "div.poster.poster-xs",
              $("ul.clearfix.latest-updates").first()
            ).toArray()) {
              const id =
                (_b =
                  (_a = $("a", manga).attr("href")) === null || _a === void 0
                    ? void 0
                    : _a.replace("/manga/", "")) !== null && _b !== void 0
                  ? _b
                  : "";
              const mangaDate = parseDate(
                (_c = $("span.date", manga).text().trim()) !== null &&
                  _c !== void 0
                  ? _c
                  : ""
              );
          ...
          const parseHomeSections = ($, sectionCallback) => {
            ...
            const hotUpdateSection = createHomeSection({
              id: "hot_update",
              title: "Hot Manga Updates",
            });
            const popularMangaSection = createHomeSection({
              id: "popular_manga",
              title: "Popular Manga",
              view_more: true,
            });
            const latestUpdateSection = createHomeSection({
              id: "latest_updates",
              title: "Latest Updates",
              view_more: true,
            });
            const newMangaSection = createHomeSection({
              id: "new_manga",
              title: "New Manga",
            });
            //Hot Mango Update
            ...
            for (const manga of $("ul#latest_trailers li").toArray()) {
              ...
              const id =
                (_c =
                  (_b = $("a", manga).attr("href")) === null || _b === void 0
                    ? void 0
                    : _b.split("/").pop()) !== null && _c !== void 0
                  ? _c
                  : "";
              const parseImage = getImageSrc($("img", manga));
              const image = parseImage
                ...
                : "https://i.imgur.com/GYUxEX8.png";
              const subtitle =
                (_d = $("small", manga).first().text().trim()) !== null &&
                _d !== void 0
                  ? _d
                  : "";
              if (!id || !title) continue;
            ...
            for (const manga of $(
              ...
              const id =
                (_f =
                  (_e = $("a", manga).attr("href")) === null || _e === void 0
                    ? void 0
                    : _e.split("/").pop()) !== null && _f !== void 0
                  ? _f
                  : "";
              const parseImage = getImageSrc($("img", manga));
              const image = parseImage
                ? RM_DOMAIN + parseImage
                : "https://i.imgur.com/GYUxEX8.png";
              let subtitle = $("div.poster-subject > ul.chapters > li", manga)
                .first()
                .text()
                .trim();
              subtitle = subtitle ? "Chapter " + subtitle : "";
            ...
            for (const manga of $("li", "ul.clearfix.mb-0").toArray()) {
              ...
              const id =
                (_h =
                  (_g = $("a", manga).attr("href")) === null || _g === void 0
                    ? void 0
                    : _g.split("/").pop()) !== null && _h !== void 0
                  ? _h
                  : "";
              const parseImage = getImageSrc($("img", manga));
              const image = parseImage
          ...
          const parseViewMore = ($, homepageSectionId) => {
            ...
            if (homepageSectionId === "popular_manga") {
              for (const m of $("li.mb-lg", "ul.filter-results").toArray()) {
                ...
                const id =
                  (_b =
                    (_a = $("a", m).attr("href")) === null || _a === void 0
                      ? void 0
                      : _a.split("/").pop()) !== null && _b !== void 0
                    ? _b
                    : "";
              ...
              for (const m of $(
                ...
                const id =
                  (_d =
                    (_c = $("a", m).attr("href")) === null || _c === void 0
                      ? void 0
                      : _c.split("/").pop()) !== null && _d !== void 0
                    ? _d
                    : "";
                const parseImage = getImageSrc($("img", m));
                const image = parseImage
          ...
          const parseDate = (date) => {
            ...
            let time;
            const number = Number(
              ((_a = /\d*/.exec(date)) !== null && _a !== void 0 ? _a : [])[0]
            );
            if (
          ...
          const isLastPage = ($) => {
            ...
            const hasNext = Boolean(
              $("a:contains(»)", "div.ui.pagination.menu")[0]
            );
        ...
        { entities: 5, "paperback-extensions-common": 13 },
      ],
    },
    {},
    [56]
